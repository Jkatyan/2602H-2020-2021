...
pros::Motor lFOdom(L1, pros::LFG, LFREV, pros::E_MOTOR_ENCODER_DEGREES);
pros::Motor rFOdom(R1, pros::RFG, RFREV, pros::E_MOTOR_ENCODER_DEGREES);
pros::ADIEncoder sideEncOdom('E', 'F');
...
void updatePosition() {
  curLeft = lFOdom.get_position();
  curRight = rFOdom.get_position(); //step 1
